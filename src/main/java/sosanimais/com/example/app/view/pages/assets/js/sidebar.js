class SideBar extends HTMLElement{
    ...
    <div class="menu-item">
        ...
        <div class="dropdown-menu">
            ...
            <a href="../acolhimento/pageRegistroAcolhimento.html" class="dropdown-item">
                <i class="fas fa-plus-circle"></i>
                Cadastrar novo
            </a>
        </div>
    ...
    <div class="menu-item">
        ...
        <div class="dropdown-menu">
            <a href="../Insumo/pageRelatorioInsumo.html" class="dropdown-item">
                <i class="fas fa-list"></i>
                Listar todos
            </a>
        ...
        <div class="dropdown-menu">
            <a href="../MedicarVacinar/pageRelatorioVM.html" class="dropdown-item">
                <i class="fas fa-list"></i>
                Listar todas
            </a>
